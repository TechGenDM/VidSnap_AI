...
CREATOR_PRESETS: dict[str, CreatorPreset] = {
    "tech_creator": CreatorPreset(
        ...
        music="upbeat_pulse",
        length="30s",
        description="High-momentum technical breakdown with punchy kinetic captions and driving audio.",
    ),
    "educational": CreatorPreset(
        ...
        music="ambient_chill",
        length="30s",
        description="Calm, highly structured explanation with clean visuals and ambient score.",
    ),
    "storytelling": CreatorPreset(
        ...
        music="lofi_beat",
        length="45s",
        description="Warm, reflective narrative journey with rich cinematic framing.",
    ),
    "product_showcase": CreatorPreset(
        ...
        music="upbeat_pulse",
        length="15s",
        description="Snappy, visual-first product demo highlighting benefits and quick CTA.",
    ),
    "personal_story": CreatorPreset(
        ...
        music="lofi_beat",
        length="30s",
        description="Intimate, conversational reflection with thoughtful pacing.",
    ),
}
